...
// initialization of extra data structures
typedef struct _node Node;
typedef struct _blocked_list Blocked_list;
Thread *remove_list(Blocked_list *list);
void add_list(Blocked_list *list, Thread *threadp);
