...
__sthread_lock:               
        ...
        # move what we want in scheduler_lock atomically
        movl    $1, %eax
...
__sthread_restore:
        ...
        # call here so it happens at right time
...
__sthread_start:
        ...
        call    __sthread_unlock  # call right before scheduler
        call    __sthread_scheduler
